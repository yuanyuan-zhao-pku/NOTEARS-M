...
write.csv(results_avg, file.path(default_save_path, "acc_d_MMHC.csv"), row.names = FALSE)   
write.csv(results, file.path(default_save_path, "each_acc_d_MMHC.csv"), row.names = FALSE)   
