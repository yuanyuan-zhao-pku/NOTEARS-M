...
write.csv(results_avg, file.path(default_save_path, "acc_k_MMHC.csv"), row.names = FALSE)   
write.csv(results, file.path(default_save_path, "each_acc_k_MMHC.csv"), row.names = FALSE)   
